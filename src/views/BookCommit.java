 ...
 * @author cgnt
 */
public class BookCommit extends javax.swing.JFrame {

    /**
     * Creates new form BookCommit
     */
    public BookCommit() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Roll No", "Name", "Course", "Semester", "Email", "Phone No", "Book Title", "Book Author", "Book ID", "About", "Edition"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookCommit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BookCommit().setVisible(true);
            }
        });
    }
